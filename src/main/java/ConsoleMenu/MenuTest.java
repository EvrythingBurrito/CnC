...
public class MenuTest {	
	private void mainMenu() {
		...
		menu.addItem(new MenuItem("Option A", this, "subMenuA", null));
		menu.addItem(new MenuItem("Option B", this, "subMenuB", null));
		menu.addItem(new MenuItem("Option C", this, "performOptionC", null));
		menu.execute();
	}
